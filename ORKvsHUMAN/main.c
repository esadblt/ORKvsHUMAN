...
#define MAX_UNITS_PER_CELL 100
        ...
        // Esad Bulat 230201037
        // Ahmet Emre Yavuz 230201088
...
void CanBariCiz(int x, int y, int can, int maxcan) {
    ...
    DrawRectangle(x, y, GRID_CELL_SIZE, 5, LIGHTGRAY);  // Arka plan
    DrawRectangle(x, y, GRID_CELL_SIZE * canYuzdesi, 5, barColor);  // Saðlýk barý
}
